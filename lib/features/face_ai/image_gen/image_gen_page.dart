...
class ImageGenPage extends StatefulWidget {
  ...
  const ImageGenPage({super.key, required this.pathFile, required this.needUpload});
...
class _ImageGenPageState extends State<ImageGenPage> {
  late final ImageGenController _controller;
  final _loadingOverlay = ElaboratedLoadingOverlay(url: Assets.loadingAILoading);

  ImageGenController _createController() {
    _controller = ImageGenController(widget.pathFile, widget.needUpload);
    return _controller;
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<ImageGenController, ImageGenState>(
        builder: (context, state) {
          return Scaffold(
            appBar: AppBarComponent(
              title: AppText(
                context.loc.photo_swap,
  ...
  Widget _buildUI(BuildContext context, ImageGenState state) {
    return Padding(
  ...
  Widget _buildBottomUI(BuildContext context, ImageGenState state) {
    return Container(
  ...
  Widget _buildImageGrid(BuildContext context, ImageGenState state) {
    return Expanded(
      child: AnimatedGrid(
  ...
  Widget _buildIndividualImage(BuildContext context, ImageGenState state,
  ...
  Widget _buildProcessIndicator(BuildContext context, ImageGenState state) {
    return Padding(
  ...
  Widget _buildImageUploadFAB(BuildContext context, ImageGenState state) {
  ...
  void _handleGen(BuildContext context, ImageGenState state) async {
