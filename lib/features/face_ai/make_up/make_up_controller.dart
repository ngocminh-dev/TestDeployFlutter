import 'package:photo_ai/features/face_ai/make_up/make_up_state.dart';
...
class MakeUpController extends Cubit<MakeUpState> {
  ...
  MakeUpController(String pathFile, bool needUpload)
      : _pathFile = pathFile,
        _needUpload = needUpload,
        super(const MakeUpState(loading: true)) {
    _init();
  }
