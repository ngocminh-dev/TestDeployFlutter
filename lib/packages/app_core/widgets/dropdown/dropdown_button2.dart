...
class DropdownButtonFormField2<T> extends FormField<T> {
  ...
  DropdownButtonFormField2({
    ...
    MenuItemStyleData menuItemStyleData = const MenuItemStyleData(
      padding: EdgeInsets.symmetric(horizontal: YDSpacing.padding16X),
    ),
  ...
  static InputDecoration _getInputDecoration(
    ...
    return decoration ??
        InputDecoration(
          errorStyle: AppTextStyle.subtitle4.copyWith(
            color: AppColor.alertErrorSub,
            height: 1.0,
          ),
          contentPadding: const EdgeInsets.only(
            left: 0,
            right: YDSpacing.padding8X,
            top: 0,
            bottom: 0,
          ),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: AppColor.borderBorder),
          ),
